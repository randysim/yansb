...
export default async function Home() {
    ...
    const heroMarqueeImages = [
        <Image key={1} src="/images/drizzle-light-background.png" alt="Drizzle ORM" width={200} height={80} className="mx-8" />,
        <Image key={2} src="/images/nextjs-light-background.png" alt="Next.js" width={360} height={80} className="mx-8" />,
        <Image key={3} src="/images/authjs-light-background.png" alt="Auth.js" width={220} height={80} className="mx-8" />,
        <Image
            key={4}
            ...
            className="mx-8"
        />,
        <Image key={5} src="/images/ts-light-background.png" alt="Typescript" width={80} height={80} className="mx-8" />,
        <Image key={6} src="/images/shadcnui-light-background.png" alt="shadcn/ui" width={340} height={80} className="mx-8" />,
        <Image
            key={7}
            ...
            className="mx-8"
        />,
        <Image key={8} src="/images/stripe-light-background.png" alt="Stripe" width={190} height={80} className="mx-8" />,
    ]
        ...
        <div className="pb-24">
            ...
            <section className="flex flex-col items-center text-center py-24">
                ...
                <div className="relative flex w-full max-w-6xl flex-col items-center justify-center overflow-hidden mt-10">
                    <Marquee>{heroMarqueeImages}</Marquee>
